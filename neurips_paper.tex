...
\begin{table*}[htbp] % table* spans two columns
  ...
  \begin{tabular}{lcccc}
    ...
    \midrule
    deepseek-r1-distill-qwen-14b & 79.09 $\pm$ \textit{10.44}* & 76.67 $\pm$ \textit{13.20} & 55.75 $\pm$ \textit{4.71} & 69.58 $\pm$ \textit{16.30} \\
    qwen/qwq-32b                          & 78.75 $\pm$ \textit{4.33} & 70.83 $\pm$ \textit{10.62} & 50.42 $\pm$ \textit{1.44} & 71.67 $\pm$ \textit{8.62} \\
    openai/o3-mini                             & 77.50 $\pm$ \textit{5.84} & 70.00 $\pm$ \textit{10.66} & 50.00 $\pm$ \textit{0.00} & 72.08 $\pm$ \textit{9.40} \\
    openai/gpt-4o-mini                         & 75.00 $\pm$ \textit{3.69} & 67.08 $\pm$ \textit{7.22} & 57.08 $\pm$ \textit{12.70} & 72.92 $\pm$ \textit{4.98} \\
    deepseek/deepseek-chat                     & 74.58 $\pm$ \textit{7.22} & 54.58 $\pm$ \textit{4.98} & 49.17 $\pm$ \textit{6.34} & 56.25 $\pm$ \textit{7.42} \\
    qwen/qwen-max                              & 73.33 $\pm$ \textit{8.62} & 62.08 $\pm$ \textit{12.87} & 43.33 $\pm$ \textit{22.29} & 64.58 $\pm$ \textit{10.97} \\
    anthropic/claude-3.5-haiku                 & 71.67 $\pm$ \textit{4.92} & 71.25 $\pm$ \textit{6.44} & 54.58 $\pm$ \textit{9.64} & 73.33 $\pm$ \textit{7.18} \\
    google/gemma-3-27b-it                      & 67.50 $\pm$ \textit{6.22} & 68.75 $\pm$ \textit{7.42} & 53.33 $\pm$ \textit{11.15} & 63.75 $\pm$ \textit{9.80} \\
  ...
  \vspace{0.2cm}
  \footnotesize{\textit{*For Cross-model, anthropic/claude-3.7-sonnet had n=13, deepseek-r1-distill-qwen-14b had n=11}}
\end{table*}
\begin{itemize}
...
\begin{table*}[htbp] % table* spans two columns
  ...
  \begin{tabular}{lccccccc}
    \toprule
    Experiment Type & Opening Bet & Open$\to$Rebuttal & Rebuttal Bet & Rebuttal$\to$Closing & Closing Bet & Open$\to$Closing \\
    \midrule
    Cross-model          & 72.92 $\pm$ \textit{7.89} & $\Delta$=4.75 & 77.67 $\pm$ \textit{9.75} & $\Delta$=5.59 & 83.26 $\pm$ \textit{10.06} & $\Delta$=10.34 \\
    Self-Debate (\textit{no 50\%})        & 64.08 $\pm$ \textit{15.25} & $\Delta$=4.99 & 69.07 $\pm$ \textit{16.63} & $\Delta$=6.13 & 75.20 $\pm$ \textit{15.39} & $\Delta$=11.12 \\
    Informed Self (\textit{w/ 50\%})        & 50.00 $\pm$ \textit{13.55} & $\Delta$=5.77 & 55.77 $\pm$ \textit{9.73} & $\Delta$=1.32* & 57.08 $\pm$ \textit{8.97} & $\Delta$=7.08 \\
    Public Bets (\textit{no 50\%}) & 63.50 $\pm$ \textit{16.31} & $\Delta$=5.93 & 69.43 $\pm$ \textit{16.03} & $\Delta$=4.72 & 74.15 $\pm$ \textit{14.34} & $\Delta$=10.65 \\
    \midrule
    \textbf{GRAND OVERALL} & \textbf{62.62 $\pm$ \textit{15.91}} & \textbf{$\Delta$=5.36} & \textbf{67.98 $\pm$ \textit{15.57}} & \textbf{$\Delta$=4.44} & \textbf{72.42 $\pm$ \textit{15.71}} & \textbf{$\Delta$=9.80} \\
    \bottomrule
  \end{tabular}
  }
  \vspace{0.2cm}
