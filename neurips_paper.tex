...
\begin{table*}[htbp] % table* spans two columns
  ...
  \begin{tabular}{lccccccc}
    ...
    \midrule
    Cross-model          & 72.92 $\pm$ 7.89 & $\Delta$=4.75 & 77.67 $\pm$ 9.75 & $\Delta$=5.59 & 83.26 $\pm$ 10.06 & $\Delta$=10.34 \\
    Self-Debate (\textit{no 50\%})        & 64.08 $\pm$ 15.25 & $\Delta$=4.99 & 69.07 $\pm$ 16.63 & $\Delta$=6.13 & 75.20 $\pm$ 15.39 & $\Delta$=11.12 \\
    Informed Self (\textit{w/ 50\%})        & 50.00 $\pm$ 13.55 & $\Delta$=5.77 & 55.77 $\pm$ 9.73 & $\Delta$=1.32* & 57.08 $\pm$ 8.97 & $\Delta$=7.08 \\
    Public Bets (\textit{no 50\%}) & 63.50 $\pm$ 16.31 & $\Delta$=5.93 & 69.43 $\pm$ 16.03 & $\Delta$=4.72 & 74.15 $\pm$ 14.34 & $\Delta$=10.65 \\
    \midrule
    \textbf{GRAND OVERALL} & \textbf{62.62 $\pm$ 15.91} & \textbf{$\Delta$=5.36} & \textbf{67.98 $\pm$ 15.57} & \textbf{$\Delta$=4.44} & \textbf{72.42 $\pm$ 15.71} & \textbf{$\Delta$=9.80} \\
    \bottomrule
  \end{tabular}
  }
  \vspace{0.2cm}
