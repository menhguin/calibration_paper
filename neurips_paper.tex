...
\begin{table*}[htbp] % table* spans two columns
  ...
  \begin{tabular}{lcccc}
    ...
    \midrule
    deepseek/deepseek-r1-distill-qwen-14b:free & 79.09 $\pm$ \textit{10.44}* & 76.67 $\pm$ \textit{13.20} & 55.75 $\pm$ \textit{4.71} & 69.58 $\pm$ \textit{16.30} \\
    qwen/qwq-32b:free                          & 78.75 $\pm$ \textit{4.33} & 70.83 $\pm$ \textit{10.62} & 50.42 $\pm$ \textit{1.44} & 71.67 $\pm$ \textit{8.62} \\
